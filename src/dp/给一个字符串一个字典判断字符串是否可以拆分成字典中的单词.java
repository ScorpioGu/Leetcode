 ...
 * Given a non-empty string s and a dictionary wordDict containing a linklist of non-empty words, determine if s can be segmented into a space-separated sequence of one or more dictionary words.
 *
 * Note:
 *
