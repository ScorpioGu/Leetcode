...
/**
 * @Desc https://leetcode.com/problems/min-stack_queue/description/
 * Design a stack_queue that supports push, pop, top, and retrieving the minimum element in constant time.
 *
 * push(x) -- Push element x onto stack_queue.
 * pop() -- Removes the element on top of the stack_queue.
 * top() -- Get the top element.
 * getMin() -- Retrieve the minimum element in the stack_queue.
 *
